...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        ?>
        <tr class="status_<?php echo $list[$i]['wr_10'];?>">
            <?php if ($is_checkbox) { ?>
            <td class="td_chk">
            ...
            <?php } ?>
            <td class="td_num2"><?=$list[$i]['num']?></td><!-- 번호 -->
            <!-- 제목 -->
            ...
            <td class="td_modify sv_use" style="display:<?=(!$member['mb_manager_yn'])?'none':''?>;"><!-- 수정 -->
                <a href="<?php echo G5_USER_ADMIN_BBS_URL?>/write.php?w=u&bo_table=<?=$bo_table?>&wr_id=<?=$list[$i]['wr_id'].'&'.$qstr?>">수정</a>
            </td>
        </tr>
        <?php } ?>

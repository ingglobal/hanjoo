...
$group_array = array('err','err','err','err','err','err','err','pre');
// $dta_code_array = array('M1100','M1009','M179F');
$dta_code_array = array('M1605','M1605');
...
<table>
	...
	<tr><td>IMP idx1</td><td><input type="text" name="imp_idx[]" value="<?=rand(3,3)?>"></td></tr>
	...
	<tr><td>시간1</td><td><input type="text" name="dta_time[]" value="<?=date("H:i:s",time())?>"></td></tr>

    ...
    //								 console.log(i+':'+v);
				...
				<tr>
					...
					<td>
                        ...
                        ?>
						<input type="hidden" name="ser_mb_id" value="<?=$mb1['mb_id']?>" class="frm_input" style="width:100px">
						<input type="text" name="ser_mb_name" value="<?=$mb1['mb_name']?>" class="frm_input" style="width:100px" readonly>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>" tr_id="<?php echo $row['apc_idx'] ?>">
        ...
        <td class="td_apc_status"><?=$g5['set_apc_status_value'][$row['apc_status']]?></td><!-- 상태 -->

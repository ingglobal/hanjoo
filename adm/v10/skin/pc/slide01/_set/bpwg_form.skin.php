...
<table class="tbl_frm" id="bwg_skin_opt">
	...
	<tbody>
		<tr>
			<th>기본너비(폭)</th>
			<td class="bwg_help">
				<?php echo bwg_help("메인배너 영역의 기본너비를 설정.<br>(미세조정은 키보드의 방향키로 하세요.)",1,'#f9fac6','#333333'); ?>
				<?php
		...
		<tr>
			...
			<!--th>세로슬라이드</th>
			<td class="bwg_help">
				<?php //echo bwg_help("세로방향 슬라이드의 사용여부를 설정하세요.",1,'#f9fac6','#333333'); ?>
			...
			<th>세로스와이프</th>
			<td class="bwg_help">
				<?php //echo bwg_help("세로방향 스와이프의 사용여부를 설정하세요.",1,'#f9fac6','#333333'); ?>

...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr style="display:<?=($w!='u')?'none':''?>;">
        ...
        <td colspan="3">
            <?=help('잡코리아, 사람인, 인크루트 등에 배포하고 연결할 링크입니다. 아래 코드를 복사하시면 됩니다.<br>등록양식 페이지와 공고보기 페이지 2개 링크가 있습니다. 목적에 맞는 링크를 복사하셔서 활용하세요.')?>
            <div><span style="color:#818181;">등록양식 페이지:</span> <a href="<?=G5_URL.'/recruit/?'.${$pre}['rct_idx']?>" target="_blank"><?=G5_URL.'/recruit/?'.${$pre}['rct_idx']?></a></div>
            <div><span style="color:#818181;">공고보기 페이지:</span> <a href="<?=G5_URL.'/recruit/view.php?rct_idx='.${$pre}['rct_idx']?>" target="_blank"><?=G5_URL.'/recruit/view.php?rct_idx='.${$pre}['rct_idx']?></a></div>
        </td>
    </tr>
    <tr>
        <?php
    ...
    $ar['id'] = 'rct_memo';
    $ar['name'] = '관리자 메모';
    $ar['help'] = '채용공고와 관련한 메모를 기록하고 관리하세요.';
    $ar['type'] = 'textarea';
    $ar['value'] = ${$pre}[$ar['id']];
    $ar['colspan'] = 3;

...
<form name="frmcontentform" action="./content_form_update.php" onsubmit="return frmcontentform_check(this);" method="post" enctype="MULTIPART/FORM-DATA" >
...
<div class="btn_fixed_top">
    <a href="./content_list.php" class="btn btn_02">목록</a>
